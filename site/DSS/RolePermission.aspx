<%@ Page Title="" Language="C#" MasterPageFile="~/DSS/Site.Master" AutoEventWireup="true" CodeBehind="RolePermission.aspx.cs" Inherits="DSS.DSS.RolePermission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Назначение разрешений для роли
</asp:Content>
