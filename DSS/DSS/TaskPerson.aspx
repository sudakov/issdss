<%@ Page Title="" Language="C#" MasterPageFile="~/DSS/Site.Master" AutoEventWireup="true" CodeBehind="TaskPerson.aspx.cs" Inherits="DSS.DSS.TaskPerson" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Назначение пользователей для задачи
</asp:Content>
