<%@ Page Title="" Language="C#" MasterPageFile="~/DSS/Site.Master" AutoEventWireup="true" CodeBehind="Task.aspx.cs" Inherits="DSS.DSS.Task" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            ...
            <td style="width:50px;">
                <asp:ImageButton ID="_IMGBTN_Add" runat="server" ImageUrl="Images/add.gif" AlternateText="Добавить задачу" CssClass="imgInGrid" Visible="false" ToolTip="Добавить задачу" />
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <asp:UpdatePanel ID="_UP_GridView" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:SqlDataSource ID="_DS_DataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DSSConnectionString %>" SelectCommand="dbo.issdss_task_Read_All" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                        ...
                        <asp:GridView ID="_GV_MainGridView" runat="server" DataSourceID="_DS_DataSource" CssClass="contentItem"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Удалить" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <div onclick="return confirm('ВНИМАНИЕ!!!\n\nПри удалении задачи также будет удалена информация обо всех объектах\n(альтернативы, критерии, экспертные оценки, планы, роли и т.д.),\nприсущих данной задаче, без возможности их последующего восстановления.\n\nВы действительно хотите удалить выбранную задачу?');" style="width:1px; margin:auto 0px;">
