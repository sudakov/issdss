<%@ Page Title="" Language="C#" MasterPageFile="~/DSS/Site.Master" AutoEventWireup="true" CodeBehind="PersonAlternative.aspx.cs" Inherits="DSS.DSS.PersonAlternative" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Назначение альтернатив для пользователя
</asp:Content>
